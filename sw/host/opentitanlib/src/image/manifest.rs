...
mod tests {
    ...
    pub fn test_delegation_cert_layout() {
        ...
        assert_eq!(offset_of!(ManifestExtDelegationCert, cert_type), 8);
        assert_eq!(offset_of!(ManifestExtDelegationCert, version), 12);
        assert_eq!(offset_of!(ManifestExtDelegationCert, owner_key_id), 16);
        assert_eq!(offset_of!(ManifestExtDelegationCert, delegate_key_alg), 20);
        assert_eq!(offset_of!(ManifestExtDelegationCert, delegate_public_key), 24);
