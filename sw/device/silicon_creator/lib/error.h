...
#define DEFINE_ERRORS(X) \
  ...
  X(kErrorOwnershipInvalidDelegationDepth, ERROR_(27, kModuleOwnership, kInvalidArgument)), \
  X(kErrorOwnershipInvalidCertType, ERROR_(28, kModuleOwnership, kInvalidArgument)), \
  X(kErrorOwnershipInvalidPolicySubsetting, ERROR_(29, kModuleOwnership, kInvalidArgument)), \
  \
